    ...
    <section class="section profile">
      <div class="row">
        <div class="col-xl-4">
          ...
          $query = "SELECT * FROM `user_profile` where `name` = '$staff_name' ";
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="updateProfile.php" method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="about" class="form-control" id="about" style="height: 60px"><?php echo $row['about'] ?></textarea>
                      </div>
                    </div>
                ...
                if (isset($_POST['submitBtn'])) {
                  ...
                  $query = "SELECT PASSWORD FROM `users` WHERE `username` = '{$staff_name}'";
                  ...
                  if ($newpassword == $renewpassword) {
                    if (!$newpassword == "") {
                      $updateQuery = "Update `users` set `PASSWORD` = '{$newpassword}'  WHERE `username` = '{$staff_name}'";
                    ...
                    echo "new password and re enter password are mismatch...";
                  }
                }
                ?>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                    ...
                    <div class="text-center">
                      <button type="submit" name="submitBtn" class="btn btn-primary">Change Password</button>
                    </div>
