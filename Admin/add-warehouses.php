...
<head>
    ...
    <title>Add Warehouse - Admin</title>
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                                ...
                                if (isset($_POST['add-warehouse'])) {
                                    ...
                                    $query = "INSERT INTO `warehouse`( `warehouse_no`, `phone`, `email`, `address`) VALUES ('$warehouse_no','$phone','$email','$address')";
                                ...
                                <div class="row border">
                                    <div class="col-md-12">
                                        ...
                                        <div class=" mb-3">
                                            ...
                                            <div class="">
                                                <input type="text" name="warehouse_no" required class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class=" mb-3">
                                            ...
                                            <div class="">
                                                <textarea name="address" required class="form-control" style="height: 60px"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-sm-10">
                                            <button type="submit" name="add-warehouse" class="btn btn-primary">Add</button>
                                        </div>
                                    </div>
