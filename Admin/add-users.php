                    ...
                    <div class="card py-3">
                        <div class="card-body">
                            ...
                            if (isset($_POST['add'])) {
                                ...
                                $insertUserQuery = "INSERT INTO `users`(`username`, `password`, `gender`, `image`, `phone`, `email`) VALUES ('{$username}','{$password}','{$gender}','{$destination}','{$phone}','{$email}')";
                                ...
                                <div class="row border">
                                    <div class="col-lg-6 ">
                                        ...
                                        <div class=" mb-3">
                                            ...
                                            <div class="">
                                                <select class="form-select m-0" required name="gender" aria-label="Default select example">
