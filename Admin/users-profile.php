          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                <!-- fetch user profiles data from databases -->
                  ...
                  <form action="updateProfile.php" method="post">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="<?php echo $row['profile_image'] ?>" alt="Profile">
                        <div class="pt-2">
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <!-- SELECT PASSWORD FROM `admin_login` WHERE id = 1; -->
                  ...
                  <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                    ...
                    if (isset($_POST['submitBtn'])) {
                      ...
                      $query = "SELECT PASSWORD FROM `admin_login` WHERE id = 1";
                      ...
                      if ($newpassword == $renewpassword) {
                        if (!$newpassword == "") {
                          $updateQuery = "Update `admin_login` set `PASSWORD` = '{$newpassword}'  WHERE id = 1";
